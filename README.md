# NFT Project following the tutorial provided by App Brewery LTD (www.appbrewery.com)
...
```
dfx canister call <Canister ID> transferOwnership '(principal "", true)'
```
