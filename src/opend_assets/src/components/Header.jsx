...
import homeImage from "../../assets/default-monochrome.svg";
...
function Header() {
  ...
  return (
    <BrowserRouter forceRefresh={true}>
      <div className="app-root-1">
        <header className="Paper-root AppBar-root AppBar-positionStatic AppBar-colorPrimary Paper-elevation4">
          <div className="Toolbar-root Toolbar-regular header-appBar-13 Toolbar-gutters">
            ...
            <Link to="/">
              <h5 className="Typography-root header-logo-text">UniToken</h5>
            </Link>
      ...
      <Switch>
        <Route exact path="/">
          <img className="bottom-space" src={homeImage} width={350} height={350} style={{margin:5}} />
          <p style={{fontSize:50}}>
                Crypto
